...
/* harmony export */   "modulePopular": () => (/* binding */ modulePopular),
/* harmony export */   "moduleSuggetion": () => (/* binding */ moduleSuggetion),
/* harmony export */   "productSliderPage": () => (/* binding */ productSliderPage),
/* harmony export */   "setGoodsSlider": () => (/* binding */ setGoodsSlider),
/* harmony export */   "sliderAbout": () => (/* binding */ sliderAbout),
/* harmony export */   "sliderBlog": () => (/* binding */ sliderBlog),
...
const mainSlider = () => {
  ...
  const enableSwiper = function () {
    mySwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.slider-main__swiper', {
...
const setGoodsSlider = () => {
  ...
  const enableSwiper = function () {
    ...
    mySwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.set-goods__slider', {
      // configure Swiper to use modules
      slidesPerView: 1.2,
      spaceBetween: 10,
      breakpoints: {
...
const modulePopular = () => {
  ...
  const enableSwiper = function () {
    try {
      mySwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.popular-slider', {
        // configure Swiper to use modules
        slidesPerView: 1.1,
        spaceBetween: 10,
        breakpoints: {
...
const moduleSuggetion = () => {
  ...
  const enableSwiper = function () {
    // console.log(typeof (obj[key].container))
    mySwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.suggetion-slider', {
      // configure Swiper to use modules
      slidesPerView: 1.1,
      spaceBetween: 10,
      breakpoints: {
...
const sliderReview = () => {
  if (document.querySelector('.review-module__slider')) {
    ...
    const reviewSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.review-module__slider', {
      // configure Swiper to use modules
      modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation],
      slidesPerView: 1.1,
      spaceBetween: 10,
...
const sliderBlog = () => {
  if (document.querySelector('.module-blog__items')) {
    ...
    const reviewSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.module-blog__items', {
      // configure Swiper to use modules
      slidesPerView: 1.1,
      spaceBetween: 10,
      breakpoints: {
...
const sliderAbout = () => {
  ...
  const enableSwiper = function () {
    // console.log(typeof (obj[key].container))
    mySwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.about__items', {
      // configure Swiper to use modules
      slidesPerView: 1.1,
      spaceBetween: 10,
      breakpoints: {
...
const productSliderPage = () => {
  if (document.querySelector('.main-product-slider')) {
    const thumbsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.thumb-product-slider', {
      // configure Swiper to use modules
      observer: true,
      observeParents: true,
      slidesPerView: 3,
    ...
    const productSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.main-product-slider', {
      // configure Swiper to use modules
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _bodyLock_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(111);
...
const menu = () => {
  ...
  burgerHeader.addEventListener('click', () => {
    ...
    (0,_bodyLock_js__WEBPACK_IMPORTED_MODULE_0__.bodyLockToggle)();
  });
  ...
  btnCatalog.forEach(el => {
    el.addEventListener('click', () => {
      ...
      (0,_bodyLock_js__WEBPACK_IMPORTED_MODULE_0__.bodyLock)();
    });
  });
  ...
  /*MODALNOTIFICATION*/
  // const favoriteBtns = document.querySelectorAll('.button-card__favorite');
  // const modalNotification = document.querySelector('.modal-notification');
  // favoriteBtns.forEach((item) => {
  //   item.addEventListener('click', () => {
  //     modalNotification.classList.add('modal-notification_active');
  //     overlay.classList.add('modal-ovelay_active');
  //     bodyLock();
  //   });
  // });
  ...
  closeBtn.forEach(btn => {
    btn.addEventListener('click', (e) => {
      ...
      if (e.target.closest('.modal-category')) {
        ...
        (0,_bodyLock_js__WEBPACK_IMPORTED_MODULE_0__.bodyUnlock)();
      }
      ...
      if (e.target.closest('.modal-notification')) {
        console.log('hi')
        modalNotification.classList.remove('modal-notification_active');
        overlay.classList.remove('modal-ovelay_active');
        (0,_bodyLock_js__WEBPACK_IMPORTED_MODULE_0__.bodyUnlock)();
      }
    });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_notification_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _modules_spollers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var typed_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
/* harmony import */ var _modules_sliders_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(106);
/* harmony import */ var _modules_accordion_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(107);
/* harmony import */ var _modules_scrollMenu_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(108);
/* harmony import */ var _modules_tabs_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(109);
/* harmony import */ var _modules_menu_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(110);
/* harmony import */ var _libs_select_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(112);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_notification_js__WEBPACK_IMPORTED_MODULE_0__["default"])();
  //Адаптивный споллер для футера
  (0,_modules_spollers_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
  //слайдер главная промо
  (0,_modules_sliders_js__WEBPACK_IMPORTED_MODULE_4__.mainSlider)();
  //слайдер главная Подберем набор
  (0,_modules_sliders_js__WEBPACK_IMPORTED_MODULE_4__.setGoodsSlider)();
  //слайдер главная модуль популярные
  (0,_modules_sliders_js__WEBPACK_IMPORTED_MODULE_4__.modulePopular)();
  //слайдер главная модуль лучшие предложение
  (0,_modules_sliders_js__WEBPACK_IMPORTED_MODULE_4__.moduleSuggetion)();
  //слайдер главная модуль отзывы
  (0,_modules_sliders_js__WEBPACK_IMPORTED_MODULE_4__.sliderReview)();
  //слайдер главная модуль статти
  (0,_modules_sliders_js__WEBPACK_IMPORTED_MODULE_4__.sliderBlog)();
  //слайдер главная модуль о нас
  (0,_modules_sliders_js__WEBPACK_IMPORTED_MODULE_4__.sliderAbout)();
  //слайдер страница товара
  (0,_modules_sliders_js__WEBPACK_IMPORTED_MODULE_4__.productSliderPage)();
  //появление нижнего меню при скролле
  (0,_modules_scrollMenu_js__WEBPACK_IMPORTED_MODULE_6__["default"])();
  //табы на странице товара
  const tabs1 = new _modules_tabs_js__WEBPACK_IMPORTED_MODULE_7__.Tabs('tab', {});
  //споллер на странице фильтров
  (0,_modules_accordion_js__WEBPACK_IMPORTED_MODULE_5__["default"])('.item-filter-catalog__heading');
  //споллер модуль вопросов
  (0,_modules_accordion_js__WEBPACK_IMPORTED_MODULE_5__["default"])('.questions-page__hedaing');
  //модуль надписи на главной
  try {
    const typed = new typed_js__WEBPACK_IMPORTED_MODULE_2__('.write', {
  ...
  //select
  try {
    const selectCountry = new _libs_select_js__WEBPACK_IMPORTED_MODULE_9__.Select('#select-country', {
      placeholder: 'Країна',
      selectedId: '0',
      data: [
        { id: '1', value: 'Україна' },
  ...
  try {
    const selectREgion = new _libs_select_js__WEBPACK_IMPORTED_MODULE_9__.Select('#select-region', {
      placeholder: 'Область',
      selectedId: '0',
      data: [
        { id: '1', value: 'Сумська' },
  ...
  // const link = document.querySelector('.review-header-product__review');

  // link.addEventListener('click', (event) => {
  //   event.preventDefault();
  //   const tab = document.querySelector('a[href=\'#tab-review\']').click();
  //   console.log(tab);
  // });
